...
namespace DrunkManGame
{
    public class Card : IComparable
    {
        ...
        public static Dictionary<string, string> Values36 = new Dictionary<string, string>()
        {
            { "6", "6" },
            { "7", "7" },
            { "8", "8" },
        ...
        public static Dictionary<string, string> Values52 = new Dictionary<string, string>()
        {
            { "2", "2" },
            { "3", "3" },
            { "4", "4" },
